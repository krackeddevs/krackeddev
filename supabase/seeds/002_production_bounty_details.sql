-- ============================================
-- PRODUCTION SEED DATA - BOUNTY DETAILS & WINNERS
-- DO NOT RUN ON FRESH INSTALLS
-- This file contains production-specific bounty updates from migration 012
-- ============================================

-- Update bounties with complete data (from migration 012)
