...
-- Step 1: Add winner_user_id column with FK to profiles
...
-- Step 2: Link existing winners to their profiles
...
-- Step 3: Create approved bounty_submissions for winners (for My Submissions to work)
-- Note: Using flexible URL format (constraint already relaxed in migration 015)
...
-- SELECT b.slug, b.winner_name, b.winner_user_id, p.username 
-- FROM bounties b 
-- LEFT JOIN profiles p ON b.winner_user_id = p.id 
