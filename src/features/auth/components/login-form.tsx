...
export function LoginForm({ onSuccess }: LoginFormProps) {
    ...
    const LastUsedBadge = () => (
        <span className="absolute -top-2 -right-2 bg-neon-primary text-black text-[10px] font-bold px-1.5 py-0.5 uppercase tracking-tighter shadow-[0_0_10px_rgba(21,128,61,0.5)]">
            Last Used
        </span>
    );
